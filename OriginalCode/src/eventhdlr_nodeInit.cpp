...
//                }
//            }
            if(nodeData.node_isForbidden_[day][tvrp.tour_[tvrp.length_-1]][0] || nodeData.node_isForbidden_[day][0][tvrp.tour_[0]]
            ...
            else
            {
                ...
                {
                    if(!nodeData.node_timetable_[tvrp.tour_[v]][day] || nodeData.node_isForbidden_[day][tvrp.tour_[v-1]][tvrp.tour_[v]])
                    {
                        fixed = TRUE;
                        break;
                    }
